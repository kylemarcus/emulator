...
COPY TITAN(sample int,col int,ROW int,H double PRECISION) FROM :rohit DELIMITER ',';

COPY meta(sample int, Nx int, Ny int, xstart double PRECISION, xend double PRECISION, ystart double PRECISION, yend double PRECISION,logvol double PRECISION,direction double PRECISION,basal double PRECISION,internal double PRECISION) FROM :meta_data DELIMITER',';
...
COPY resamples(resample int,P1 double PRECISION,P2 double PRECISION,P3 double PRECISION,P4 double PRECISION, w double PRECISION) FROM :macro_resamples DELIMITER ' ';
...
COPY phm(id int,X double PRECISION, Y double PRECISION) FROM :phm DELIMITER ' ';

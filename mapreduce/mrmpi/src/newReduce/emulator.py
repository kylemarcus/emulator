...
#Set up uniq_uniq_dict
    ...
    fp = open('/panasas/scratch/shivaswa/emulator/my_hadoop/uniq_uniq.txt','r')
    for line in fp:
...
# Set up sample_resample_dict
    ...
    fp = open('/panasas/scratch/shivaswa/emulator/my_hadoop/sample_resample.txt','r')
    for line in fp:
...
# Set up uniq_phm_neigh_dict
    uniq_phm_neigh_dict = {}
    fp = open('/panasas/scratch/shivaswa/emulator/my_hadoop/uniq_phm.txt','r')
    for line in fp:
        match = re.findall('([\d_]+)',line)
        key = match.pop(0)

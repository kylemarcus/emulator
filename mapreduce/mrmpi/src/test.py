...
def mapEmulator(itask,filename,mr):
  ...
  # need to call map3.py which calls emulator.py and
  # pipes the results to newEmulator
  emulatorOut = emualtor()
  process = Popen(["newEmulator", stdout=PIPE, stdin=emulatorout)
